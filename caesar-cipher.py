...
#Initialize variables.: the message, the cipherKey, and the alphabet.
#Use a for loop to traverse each letter in the message.
#For a specific letter, find the position and determine the new position given the cipher key.
...
#Get a message to encrypt from the user along w/ a cipher key from the user.
#Encrypt the message and Decrypt the message.
